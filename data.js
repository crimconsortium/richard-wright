...
window.RW_DATA = {
  ...
  photos: [
    {
      src: "photos/1.jpg",
      caption: "Faculty portrait, University of Missouri–St. Louis",
      year: "",
      alt: "Outdoor portrait of Richard Wright on the UM–St. Louis campus.",
    },
    {
      src: "photos/2.jpg",
      caption: "With Jeremy Bentham’s auto-icon, University College London",
      year: "",
      alt: "Richard Wright and a colleague standing in front of the auto-icon of Jeremy Bentham at University College London.",
    },
    {
      src: "photos/3.jpg",
      caption: "Dinner with colleagues",
      year: "",
      alt: "Richard Wright at a restaurant table with two colleagues.",
    },
    {
      src: "photos/4.jpg",
      caption: "Studio portrait",
      year: "",
      alt: "Studio portrait of Richard Wright in a gray shirt against a textured backdrop.",
    },
    {
      src: "photos/5.jpg",
      caption: "“Happy Holidays from Richard and Scott” card",
      year: "",
      alt: "A printed holiday card featuring Richard Wright and Scott Jacques with the gold-foil text ‘Happy Holidays from Richard and Scott’.",
    },
    {
      src: "photos/6.jpg",
      caption: "Burglars on the Job illustration",
      year: "",
      alt: "Stylized illustration of three masked cartoon burglars; the leftmost figure has Richard Wright’s face superimposed on it.",
    },
    {
      src: "photos/7.jpg",
      caption: "Recent portrait",
      year: "",
      alt: "Recent portrait of Richard Wright seated outdoors with green foliage in the background.",
    },
  ],
};
